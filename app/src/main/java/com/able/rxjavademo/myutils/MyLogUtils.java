...
/**
 * @version 1.0.0
 * @Description 日志工具，带日志文件输入的，又可控开关的日志调试
 * @date 2016-07-08
 */
public class MyLogUtils {
    ...
    private static String MYLOG_PATH_SDCARD_DIR = "/sdcard/able/log";// 日志文件在sdcard中的路径
    ...
    public static void writeSD(String tag, Object msg) {
        writeLogtoFile("e", tag, msg.toString());
    }
